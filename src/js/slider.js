...
$(document).ready(function () {
  ...
  $('.slider-programs').on('beforeChange', function (
    slick,
    currentSlide,
    nextSlide,
  ) {
    ...
    $(
      '.initiatives-slider[data-slick-inner="' + currentData + '"]',
    ).removeClass('active');
  ...
  $('.slider-programs').on('afterChange', function (slick, currentSlide) {
    ...
    $('.initiatives-slider[data-slick-inner="' + currentData + '"]').addClass(
      'active',
    );
  });
  ...
  $('.slick-slide').click(function () {
    ...
    var prevSlide = $('.slider-programs .slick-slide.slick-current')
      .prev('.slick-slide')
      .attr('data-slick-index');

    var nextSlide = $('.slider-programs .slick-slide.slick-current')
      .next('.slick-slide')
      .attr('data-slick-index');
  ...
  Slick = (function () {
    ...
    function Slick(element, settings) {
      ...
      _.defaults = {
        ...
        asNavFor: null,
        prevArrow:
          '<button type="button" data-role="none" class="slick-prev icon-arrow-prev" aria-label="Previous" tabindex="0" role="button"></button>',
        nextArrow:
          '<button type="button" data-role="none" class="slick-next icon-arrow-next" aria-label="Next" tabindex="0" role="button"></button>',
        autoplay: false,
        autoplaySpeed: 3000,
        centerMode: false,
        centerPadding: '50px',
